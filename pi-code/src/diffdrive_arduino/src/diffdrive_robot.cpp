...
int main(int argc, char **argv)
{
  ...
  n.getParam("front_left_wheel_name", robot_cfg.front_left_wheel_name);
  n.getParam("front_right_wheel_name", robot_cfg.front_right_wheel_name);
  n.getParam("back_left_wheel_name", robot_cfg.back_left_wheel_name);
  n.getParam("back_right_wheel_name", robot_cfg.back_right_wheel_name);
